    ...
    render() {
        return(<div className="registerForm-container">
            <form onSubmit={this.handleSubmit}>
                <Name name="name" label="Name:" value={this.state.formControls.name.value} onChange={changeHandler}
                      touched={this.state.formControls.name.touched} valid={this.state.formControls.name.valid}/>

                <Name name="lastName" label="Last name:" value={this.state.formControls.lastName.value} onChange={changeHandler}
                ...
                <Password name="password" label="Introduce a password:" value={this.state.formControls.password.value}
                          ...
                          onChange={changeHandler} touched={this.state.formControls.password.touched}
                          valid={this.state.formControls.password.valid}/>

                <Picture name="picture" label="Select a profile picture"/>

                <Phone name="phone" label="Enter a phone number:" value={this.state.formControls.phone.value} onChange={changeHandler}
